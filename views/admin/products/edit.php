...
?>
    ...
    <div class="container my-5">
        ...
        <form action="<?php echo BASE_URL;?>app/product/update_product.php" method="POST" 
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="numberOfStocks" name="numberOfStocks" 
                                   placeholder="Enter number of stocks" value="<?php echo $product["stocks"]; ?>" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="unitPrice" name="unitPrice" 
                                   placeholder="Enter unit price" value="<?php echo $product["unit_price"]; ?>" 
                                   oninput="calculateTotalPrice()">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control" id="description" rows="3" name="description" placeholder="Enter product 
